...
public class ClientsService : IClientsService
{
    ...
    private async Task<bool> ClientExists(SqlConnection conn, int clientId)
    {
    ...
    private async Task<bool> TripExists(SqlConnection conn, int tripId)
    {
    ...
    private async Task<bool> IsClientAlreadyRegistered(SqlConnection conn, int clientId, int tripId)
    {
    ...
    private async Task<bool> HasTripFreeSpace(SqlConnection conn, int tripId)
    {
